...
2. You MUST update the `context.md` file located at `/Users/kimsmirnov/.gemini/antigravity/scratch/context.md` to reflect any new milestones, modified database migrations, or added/changed API endpoints.
