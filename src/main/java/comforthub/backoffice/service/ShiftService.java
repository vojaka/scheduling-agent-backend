...
public class ShiftService {
    ...
    /**
     * Persists a generated/committed shift into PostgreSQL. Best-effort: used alongside the
     * Bubble write during migration, so failures are logged rather than aborting the commit.
     */
    @Transactional
    ...
    /** Parses an ISO-8601 timestamp, tolerating both offset and instant ("...Z") forms. */
