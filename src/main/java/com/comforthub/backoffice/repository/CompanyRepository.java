...
public interface CompanyRepository extends JpaRepository<CompanyEntity, String> {
    ...
    @Query(value = "SELECT * FROM companies WHERE (is_deleted IS NOT TRUE) AND (name IS NOT NULL AND name != '') AND (:bubbleId = ANY(owners) OR :bubbleId = ANY(workers))", nativeQuery = true)
